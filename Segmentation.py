...
img = imread(folder + filenamestart + str(225) + '.png')
img = img[center[1]-searchingsize:center[1]+searchingsize,
                          center[0]-searchingsize:center[0]+searchingsize,:]

segments_fz = felzenszwalb(img, scale=100, sigma=0.5, min_size=50)
segments_slic = slic(img, n_segments=10, compactness=10, sigma=1)
segments_quick = quickshift(img, kernel_size=2, max_dist=6, ratio=0.5)
